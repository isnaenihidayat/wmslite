...
| 02 — Data Model & Auth Hardening | `apps/backend/app/Policies/**`, `apps/backend/app/Http/Controllers/Api/**`, `apps/backend/app/Models/Inbound.php`, `process/context/all-context.md`, `process/context/database/all-database.md`, `process/context/auth/all-auth.md` | Controllers also touched by Phase 1 (tests) and Phase 3 (security fixes) — sequential, not concurrent |
