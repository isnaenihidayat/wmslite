            ...
            <?php if ($_SESSION['wmslite']['type'] == '1' || $_SESSION['wmslite']['type'] == '3' || $_SESSION['wmslite']['type'] == '0') : ?>
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" style="min-width: 60px;">
                        ...
                        <li>
                            <a aria-expanded="false" role="button" href="javascript:;" class="top_menu inbounds" data-warehouse="arcadia" title="Inbound Arcadia">
                                <img class="img-menu" src="<?php echo Yii::app()->getBaseUrl(true) . "/assets/images/inbound.svg" ?>">
                            </a>
                        </li>
                        <li>
                            <a aria-expanded="false" role="button" href="javascript:;" class="top_menu inbounds" data-warehouse="marunda" title="Inbound Marunda">
                                <img class="img-menu" src="<?php echo Yii::app()->getBaseUrl(true) . "/assets/images/inbound.svg" ?>">
                            </a>
                        </li>
                        <li>
                            <a aria-expanded="false" role="button" href="<?= $this->createUrl('otrschenkerinbound/index') ?>" class="top_menu" title="Inbound List Schenker">
                                <img class="img-menu" src="<?php echo Yii::app()->getBaseUrl(true) . "/assets/images/inbound.svg" ?>">
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a aria-expanded="false" role="button" href="<?= $this->createUrl('otrschenkeroutbound/index') ?>" class="top_menu" title="Outbound List Schenker">
                                <img class="img-menu" src="<?php echo Yii::app()->getBaseUrl(true) . "/assets/images/outbound.svg" ?>">
                            </a>
                        </li>
